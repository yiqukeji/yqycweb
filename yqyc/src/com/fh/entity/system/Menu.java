...
public class Menu {
	...
	private String NAV_STATE;   //导航显示状态
	private String POSITION_STATE;//显示位置
	private String IDENTIFICATION;//网站标识
	private String F_STATE;//首页显示状态
	private  String COLUMN_IMG;//栏目图片
