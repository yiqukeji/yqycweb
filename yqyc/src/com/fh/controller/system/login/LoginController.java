...
//		this.getInfo(root);
		...
		mv.addObject("pd",pd);
		mv.addObject("LOGO",pdInfo.getString("LOGO"));
		mv.addObject("TECHNOLOGY",pdInfo.getString("TECHNOLOGY"));
		mv.addObject("BACK_IMGS",pdInfo.getString("BACK_IMGS"));
		return mv;
	}
...
//		this.getInfo(root);
	...
	public void getInfo(Map<String,Object> root) throws Exception{
		...
		pdInfo.put("INFORMATION_ID", "1");
		pdInfo = informationService.findById(pdInfo);
		root.put("LOGO", pdInfo.getString("LOGO"));	
