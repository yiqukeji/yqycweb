package com.fh.controller.web.message;
...
public class MessageController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("web/message/message_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("web/message/message_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Message到excel");
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var6", varOList.get(i).getString("C_TIME"));	    //6
			varList.add(vpd);
		}
