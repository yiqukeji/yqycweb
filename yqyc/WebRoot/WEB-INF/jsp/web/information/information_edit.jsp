				...
				<div class="row">
					...
					<form action="information/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">背景图:</td>
								<td><input type="text" name="BACK_IMGS" id="BACK_IMGS" value="${pd.BACK_IMGS}" maxlength="100" placeholder="这里输入登陆背景图" title="BACK_IMGS" style="width:86%;" onmouseover="showTU('BACK_IMGS','yulantu1');" onmouseout="hideTU('yulantu1');"/>
								<div class="yulantu" id="yulantu1"></div>
									<a class="btn btn-xs btn-info" style="margin-top: -5px;" title="选择" onclick="xuanTp('BACK_IMGS');">选择 </a>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="COPYRIGHT" id="COPYRIGHT" value="${pd.COPYRIGHT}" maxlength="100" placeholder="这里输入版权" title="版权" style="width:98%;"/></td>
							</tr>
							<tr>
