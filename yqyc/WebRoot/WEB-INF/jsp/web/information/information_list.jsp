							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										...
										<tr>
											<th class="center">背景图</th>
											<td  onmouseover="showTU('BACK_IMGS','yulantu1');" onmouseout="hideTU('yulantu1');">
											${var.BACK_IMGS}
											<input type="hidden" name="BACK_IMGS" id="BACK_IMGS" value="${var.BACK_IMGS}">
											<div class="yulantu" id="yulantu1"></div>
											</td>
										</tr>
										<tr>
