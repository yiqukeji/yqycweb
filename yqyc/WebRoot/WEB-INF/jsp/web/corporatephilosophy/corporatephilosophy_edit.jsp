		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="corporatephilosophy/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CORPORATEPHILOSOPHY_ID" id="CORPORATEPHILOSOPHY_ID" value="${pd.CORPORATEPHILOSOPHY_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="CONTENT" id="CONTENT" value="${pd.CONTENT}" maxlength="50" placeholder="这里输入内容" title="内容" style="width:98%;"/></td>
							</tr>
							<tr>
