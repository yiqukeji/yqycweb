		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="leavemsg/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="LEAVEMSG_ID" id="LEAVEMSG_ID" value="${pd.LEAVEMSG_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="LCONTENT" id="LCONTENT" value="${pd.LCONTENT}" maxlength="2000" placeholder="这里输入内容" title="内容" style="width:98%;"/></td>
							</tr>
							<tr>
