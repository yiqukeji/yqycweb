	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					<form action="program/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
						<input type="hidden" name="PROGRAM_ID" id="PROGRAM_ID" value="${pd.PROGRAM_ID}"/>
						<input type="hidden" name="TYPE" id="TYPE" value="${pd.TYPE}"/>
						<input type="hidden" name="state1" id="state1" value="${pd.IMG1}" />
						<input type="hidden" name="state2" id="state2" value="${pd.IMG2}" />
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="DESCRIPT" id="DESCRIPT" value="${pd.DESCRIPT}" maxlength="50" placeholder="这里输入描述" title="描述" style="width:98%;"/></td>
							</tr>
							<c:if test="${pd.TYPE!='04'&&pd.TYPE!='05'&&pd.TYPE!='06'&&pd.TYPE!='07'&&pd.TYPE!='08'&&pd.TYPE!='09'&&pd.TYPE!='10'}">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">焦点图1:</td>
								<td>
								   <input type="text" readonly="readonly" style="width:88%;" id="fl" value="${pd.IMG1}" name="IMG1"/>
								   <input type="file" class="form-control hidden fl" name="image_file1" />
									<span id="fpath">上传</span>
								</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;" >焦点图2:</td>
								<td>
								 <input type="text" readonly="readonly" style="width:88%;" id="fl1" value="${pd.IMG2}" name="IMG2"/>
...
<!-- /.main-container -->
	...
	<!-- mask end -->
        <script type="text/javascript" src="plugins/tupian/js/jquery.min.js"></script>
