		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="work/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="WORK_ID" id="WORK_ID" value="${pd.WORK_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">岗位:</td>
								<td><input type="text" name="JOBTITLE" id="JOBTITLE" value="${pd.JOBTITLE}" maxlength="50" placeholder="这里输入岗位" title="岗位" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">薪资:</td>
								<td><input type="text" name="SALARY" id="SALARY" value="${pd.SALARY}" maxlength="50" placeholder="这里输入薪资" title="薪资" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">招聘人数:</td>
								<td><input type="text" name="NP" id="NP" value="${pd.NP}" maxlength="20" placeholder="这里输入招聘人数" title="招聘人数" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="SOURCE" id="SOURCE" value="${pd.SOURCE}" maxlength="50" placeholder="这里输入来源" title="来源" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">内容:</td>
								<td>
								 <textarea id="editor_id" name="CONTENS" style="width:700px;height:300px;">
                                 ${pd.CONTENS}
                                  </textarea>
								</td>
							</tr>
	...
	<script charset="utf-8" src="plugins/kindeditor-4.1.10/lang/zh_CN.js"></script>
		...
		//富文本编辑器
	       KindEditor.ready(function(K) {
	    	   K.create('textarea[name="CONTENS"]', {
