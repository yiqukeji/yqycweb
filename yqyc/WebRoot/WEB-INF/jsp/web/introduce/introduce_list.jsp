...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="introduce/list.do" method="post" name="Form" id="Form">
						<!-- 检索  -->
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										...
										<tr>
										   <td>操作</td>
											<td>
												<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.INTRODUCE_ID}');">
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>introduce/goEdit.do?INTRODUCE_ID='+Id;
			 diag.Width = 860;
			 diag.Height = 680;
