...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="statistics/grlist.do" method="post" name="Form" id="Form">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<c:if test="${QX.add == 1 }">
									<a class="btn btn-mini btn-success" onclick="list();">访客记录</a>
									</c:if>
								</td>
	...
	<script type="text/javascript">
		...
		function list(){
			 top.jzts();
			 window.location.href='<%=basePath%>statistics/list.do';
		}
